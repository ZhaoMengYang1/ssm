package com.zz.ssm.action;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.zz.ssm.base.BigBaseController;
import com.zz.ssm.consts.entity.SoulTableParam;
...
public class FileRecordController extends BigBaseController {
    ...
    public Result getList(FileRecord fileRecord, SoulTableParam soulTableParam){
        ...
        long a = soulTableParam.getPage();
        long b = soulTableParam.getSize();
        PageHelper.startPage((int)a,(int)b);
        ...
        System.out.println("共有数据================================"+pageInfo.getTotal());

        return  renderDataPageSuccess(pageInfo.getTotal(),fileRecords);
    }

...
import com.zz.ssm.util.FileHandleUtil;
import com.zz.ssm.util.FileUploadConfig;
import com.zz.ssm.entity.Result;
import com.zz.ssm.entity.ResultCode;
import com.zz.ssm.util.IPUtils;
import com.zz.ssm.util.IdWorker;
import com.zz.ssm.mapper.FileRecordMapper;
import com.zz.ssm.entity.FileRecord;
import com.zz.ssm.entity.FileZoneRecord;
import com.zz.ssm.service.IFileRecordService;
...
//            }
            ...
            if(fileZoneRecords.size()>0){
                ...
                try {
                    ...
                    if(parentFileDir.isDirectory()){
                        ...
                        fileZoneRecordService.updateById(fileRecordb);//更新到文件记录
    ...
    private void updateById(FileRecord fileRecordb) {
...
//        fileRecord.setUploadCount(selFileUploadLog(fileRecord.getId()));
    ...
    @Override
    public boolean removeByIds(ArrayList arrayList) {
        // TODO Auto-generated method stub
        return false;
    }
    ...
    @Override
    public boolean selectMD5(String md5) {
        // TODO Auto-generated method stub
        return false;
    }

    @Override
    public boolean selectUploadType(Integer uploadType) {
        // TODO Auto-generated method stub
        return false;
    }
